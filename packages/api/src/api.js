...
const { Db, Sof, Susy, Net, Personal, Private, Shell, Shh, Signer, Trace, Web3 } = require('./rpc');
...
class Api extends EventEmitter {
  constructor (provider, allowSubscriptions = true, middlewareClass) {
    ...
    this._sof = new Sof(this._provider);
    this._net = new Net(this._provider);
    this._susy = new Susy(this._provider);
