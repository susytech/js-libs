...
describe('pubsub/Pubsub', () => {
  ...
  describe('accountsInfo', () => {
    beforeEach(() => {
      scope = mockWs([
        {
          method: 'susy_subscribe',
          reply: 2,
          subscription: {
            method: 'susy_subscription',
            params: {
              result: {
    ...
    it('retrieves the available account info', done => {
      instance.susy.accountsInfo((error, result) => {
  ...
  describe('Unsubscribe', () => {
    beforeEach(() => {
      scope = mockWs([
        { method: 'susy_subscribe', reply: 2 },
        { method: 'susy_unsubscribe', reply: true }
      ]);
      instance = new Pubsub(new WsSecure(TEST_WS_URL));
    });
    ...
    it('Promise gets resolved on success.', done => {
      instance.susy.accountsInfo().then(s => {
        instance.susy.unsubscribe(s).then(b => {
          expect(b).to.be.true;
          done();
        });
      });
  ...
  describe('chainStatus', () => {
    ...
    it('retrieves the chain status', done => {
      instance.susy.chainStatus((error, result) => {
        expect(error).to.be.null;
        expect(result).to.deep.equal({
  ...
  describe('gasFloorTarget', () => {
    ...
    it('returns the gasfloor, formatted', done => {
      instance.susy.gasFloorTarget((error, result) => {
        expect(error).to.be.null;
  ...
  describe('transactionsLimit', () => {
    ...
    it('returns the tx limit, formatted', done => {
      instance.susy.transactionsLimit((error, result) => {
        expect(error).to.be.null;
        expect(isBigNumber(result)).to.be.true;
  ...
  describe('minGasPrice', () => {
    ...
    it('returns the min gasprice, formatted', done => {
      instance.susy.minGasPrice((error, result) => {
        expect(error).to.be.null;
        expect(isBigNumber(result)).to.be.true;
        expect(result.eq(0x123456)).to.be.true;
        done();
  ...
  describe('netPeers', () => {
    ...
    it('returns the peer structure, formatted', done => {
      instance.susy.netPeers((error, peers) => {
        expect(error).to.be.null;
  ...
  describe('netPort', () => {
    ...
    it('returns the connected port, formatted', done => {
      instance.susy.netPort((error, count) => {
        expect(error).to.be.null;
  ...
  describe('accounts', () => {
    ...
    it('returns a list of accounts, formatted', done => {
      instance.sof.accounts((error, accounts) => {
        expect(error).to.be.null;
  ...
  describe('newHeads', () => {
    ...
    it('returns newHeads for sof_subscribe', done => {
      instance.sof.newHeads((error, block) => {
        expect(error).to.be.null;
  ...
  describe('blockNumber', () => {
    ...
    it('returns the current blockNumber, formatted', done => {
      instance.sof.blockNumber((error, blockNumber) => {
        expect(error).to.be.null;
  ...
  describe('call', () => {
    ...
    it('formats the input options & blockNumber', done => {
      instance.sof.call(
        error => {
          expect(error).to.be.null;
          expect(scope.body.susy_subscribe.params).to.deep.equal([
            'sof_call',
  ...
  describe('coinbase', () => {
    ...
    it('returns the coinbase, formatted', done => {
      instance.sof.coinbase((error, account) => {
        expect(error).to.be.null;
  ...
  describe('estimateGas', () => {
    ...
    it('returns the gas used, formatted', done => {
      instance.sof.estimateGas((error, gas) => {
        expect(error).to.be.null;
  ...
  describe('gasPrice', () => {
    ...
    it('returns the gas price, formatted', done => {
      instance.sof.gasPrice((error, price) => {
        expect(error).to.be.null;
  ...
  describe('getBalance', () => {
    ...
    it('returns the balance', done => {
      instance.sof.getBalance((error, balance) => {
        expect(error).to.be.null;
  ...
  describe('getBlockByHash', () => {
    ...
    it('formats the input hash as a hash, default full', done => {
      instance.sof.getBlockByHash(error => {
        expect(error).to.be.null;
        expect(scope.body.susy_subscribe.params).to.deep.equal([
          'sof_getBlockByHash',
          ['0x1234', false]
    ...
    it('formats the output into block', done => {
      instance.sof.getBlockByHash((error, block) => {
        expect(error).to.be.null;
  ...
  describe('getBlockByNumber', () => {
    ...
    it('assumes blockNumber latest & full false', done => {
      instance.sof.getBlockByNumber(error => {
        expect(error).to.be.null;
        expect(scope.body.susy_subscribe.params).to.deep.equal([
    ...
    it('formats the output into block', done => {
      instance.sof.getBlockByNumber((error, block) => {
        expect(error).to.be.null;
        expect(block.miner).to.equal(address);
        done();
      }, 0x1234);
  ...
  describe('getTransactionCount', () => {
    ...
    it('passes in the address (default blockNumber)', done => {
      instance.sof.getTransactionCount(error => {
        expect(error).to.be.null;
        expect(scope.body.susy_subscribe.params).to.deep.equal([
    ...
    it('passes in the address & blockNumber', done => {
      instance.sof.getTransactionCount(
        error => {
          expect(error).to.be.null;
          expect(scope.body.susy_subscribe.params).to.deep.equal([
            'sof_getTransactionCount',
